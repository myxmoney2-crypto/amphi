  ...
  return (
    <div className="group relative">
      <a
        ...
        className="block rounded-2xl border border-ink/10 bg-white p-5 pr-10 transition hover:-translate-y-0.5 hover:shadow-md"
      >
      ...
      <div className="absolute right-2 top-2">
        <DeleteCourseButton courseId={course.id} audioPath={course.audio_path} />
      </div>
    </div>
  );
}
